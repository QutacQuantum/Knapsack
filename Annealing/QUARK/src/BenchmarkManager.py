...
from applications.Knapsack.Knapsack import Knapsack
...
class BenchmarkManager:
    ...
    def generate_benchmark_configs(self) -> dict:
        ...
        if application_answer["application"] == "Knapsack":
            self.application = Knapsack()
    ...
    def load_config(self, config: dict) -> None:
        ...
        if config["application"]["name"] == "Knapsack":
            self.application = Knapsack()
